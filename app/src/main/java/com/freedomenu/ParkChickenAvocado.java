...
public class ParkChickenAvocado extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_park_chicken_avocado);
        OnClickButtonListener();
        OnClickButtonListener2();
    }

    public void OnClickButtonListener() {
        button = (Button) findViewById(R.id.button_park_chicken_avocado_no);
        ...
        button2 = (Button) findViewById(R.id.button_park_chicken_avocado_yes);
