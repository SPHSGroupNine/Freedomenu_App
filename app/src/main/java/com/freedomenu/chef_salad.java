...
public class chef_salad extends Activity {
    ...
    public void OnClickButtonListener() {
        button = (Button) findViewById(R.id.button_chef_salad_left);
    ...
    public void OnClickButtonListener2() {
        button2 = (Button) findViewById(R.id.button_chef_salad_right);
