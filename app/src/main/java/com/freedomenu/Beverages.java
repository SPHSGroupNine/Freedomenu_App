...
public class Beverages extends Activity {
    ...
    public void OnClickButtonListener() {
        button = (Button) findViewById(R.id.button_beverages_left);
    ...
    public void OnClickButtonListener2() {
        button2 = (Button) findViewById(R.id.button_beverages_right);
    ...
    public void OnClickButtonListener3() {
        ...
        button2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent("com.freedomenu.beverages_yes_no");
                        startActivity(intent);
                    }
