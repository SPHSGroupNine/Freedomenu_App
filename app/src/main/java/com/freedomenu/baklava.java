...
public class baklava extends Activity {
    ...
    public void OnClickButtonListener() {
        button = (Button) findViewById(R.id.button_baklava_left);
        ...
        button2 = (Button) findViewById(R.id.button_baklava_right);
    ...
    button3 = (Button) findViewById(R.id.button_baklava_center);
